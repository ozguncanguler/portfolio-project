  ...
  return (
    <nav className={`${navbarBackground} z-40 w-full fixed top-0 py-6`}>
      <div className="flex items-center justify-between mx-auto w-5/6">
        <div />
        {isAboveSmallScreens ? (
          <div className="flex justify-between gap-16 font-opensans text-sm font-semibold text-pale-yellow">
            <Link
              page="Home"
          ...
          <button
            className="rounded-lg  bg-deep-blue p-2 hover:bg-blue transition duration-500"
